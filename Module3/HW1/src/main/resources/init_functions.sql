...
-- 12. Extra mile. Immutable data trigger

CREATE OR REPLACE RULE immutable AS
    ON UPDATE TO student_address
    DO INSTEAD
INSERT INTO log_student_address (town, street, student_id)
  VALUES (new.town, new.street, new.student_id);